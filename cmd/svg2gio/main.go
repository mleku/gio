...
func convertAll(files []string) error {
	w := new(bytes.Buffer)
	fmt.Fprintf(w, "// Code generated by gio.mleku.dev/cmd/svg2gio; DO NOT EDIT.\n\n")
	fmt.Fprintf(w, "package %s\n\n", *pkg)
	fmt.Fprintf(w, "import \"image/color\"\n")
	fmt.Fprintf(w, "import \"math\"\n")
	fmt.Fprintf(w, "import \"gio.mleku.dev/op\"\n")
	fmt.Fprintf(w, "import \"gio.mleku.dev/op/clip\"\n")
	fmt.Fprintf(w, "import \"gio.mleku.dev/op/paint\"\n")
	fmt.Fprintf(w, "import \"gio.mleku.dev/f32\"\n\n")
