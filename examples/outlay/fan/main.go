...
import (
	...
	"gio.mleku.dev/app"
	"gio.mleku.dev/examples/outlay/fan/playing"
	xwidget "gio.mleku.dev/examples/outlay/fan/widget"
	"gio.mleku.dev/examples/outlay/fan/widget/boring"
